...
public class Put02 extends DummyRestapiBaseUrl {
    ...
    /*
    Given
    https://dummy.restapiexample.com/api/v1/update/21 adresine gidilir
   {
       "employee_name": "Ali Can",
       "employee_salary": 111111,
       "employee_age": 23,
    ...
    public void put01(){
        ...
        DummyApiDataPojo dummyData= new DummyApiDataPojo("Tom Hanks",111111,23,"Perfect image");
        DummyApiResponseBodyPojo expectedData= new DummyApiResponseBodyPojo("success",dummyData,"Successfully! Record has been updated.");

        Response response= given().spec(spec).contentType(ContentType.JSON).body(dummyData).when().put("/{first}/{second}");
